 ...
 *  <code>NSCalendarUnitMonth</code>, successive months will be displayed on the axis.
    ...
    switch ( self.referenceCalendarUnit ) {
        ...
        case NSCalendarUnitWeekOfYear:
            if ( [dateComponents respondsToSelector:@selector(setWeekOfYear)] ) {
                ...
                [NSException raise:CPTException format:@"Unsupported calendar unit: NSCalendarUnitWeekOfYear"];
            }
            break;
